  ...
  return (
    <section id="testimonios" className="bg-white">
      <div className="max-w-6xl mx-auto px-6 md:px-8 lg:px-12 py-16">
        <h2 className="text-3xl md:text-4xl font-bold mb-8">Lo que dice la gente</h2>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {opiniones.map((o) => (
            <div key={o.id} className="rounded-xl overflow-hidden border bg-white shadow-sm hover:shadow-lg transition">
              <img src={o.src} alt={o.alt} className="w-full h-auto object-cover" />
            </div>
          ))}
        </div>
      </div>
